...
namespace Shadowsocks.View
{
    public partial class LogForm : Form
    {
        ...
        private void UpdateContent()
        {
            ...
            string download = Utils.FormatBytes(controller.InboundCounter);
            string upload = Utils.FormatBytes(controller.OutboundCounter);

            this.Text = I18N.GetString("Log Viewer") + $" [in: { download }, out: {upload}]";
        }
