...
namespace Shadowsocks.Util
{
    ...
    public static class Utils
    {
        ...
        //public static StatsItem FormatBytes(long bytes)
        //{
        //    const long K = 1024L;
        //    const long M = K * 1024L;
        //    const long G = M * 1024L;
        ...
        //        {
        //            Value = Math.Round((bytes / (double)E), 2),
        //            Unit = "EiB"
        //        };
        //    }
        //    if (bytes >= T * 990)
        ...
        //        return new StatsItem()
        //        {
        //            Value = Math.Round((bytes / (double)P), 2),
        //            Unit = "PiB"
        //        };
        //    }
        //    if (bytes >= G * 990)
        ...
        //        return new StatsItem()
        //        {
        //            Value = Math.Round((bytes / (double)T), 2),
        //            Unit = "TiB"
        //        };
        //    }
        //    if (bytes >= M * 990)
        ...
        //        return new StatsItem()
        //        {
        //            Value = Math.Round((bytes / (double)G), 2),
        //            Unit = "GiB"
        //        };
        //    }
        //    if (bytes >= K * 990)
        ...
        //        return new StatsItem()
        //        {
        //            Value = Math.Round((bytes / (double)M), 2),
        //            Unit = "MiB"
        //        };
        //    }
        //    if (bytes > K * 2)
        ...
        //        return new StatsItem()
        //        {
        //            Value = Math.Round((bytes / (double)K), 2),
        //            Unit = "KiB"
        //        };
        //    }
        ...
        public static StatsItem ConvertToMiB(double bytes)
        {
            const long K = 1024L;
            const long M = K * 1024L;
            const long G = M * 1024L;
            ...
            return new StatsItem()
            {
                Value = Math.Round((bytes / (double)M), 3),
                Unit = "MiB"
            };
        }

        public static StatsItem ConvertToBytes(double miBytes)
        {
            const long K = 1024L;
            const long M = K * 1024L;
            const long G = M * 1024L;
            ...
            return new StatsItem()
            {
                Value = Math.Round((miBytes * (double)M)),
                Unit = "B"
            };
        }
